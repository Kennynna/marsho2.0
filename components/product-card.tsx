  ...
  return (
    <div className="bg-card rounded-lg overflow-hidden border border-border hover:border-primary transition-colors duration-200 flex flex-col h-full">
      ...
      <div className="flex flex-col flex-1 p-2">
        {/* Name */}
        <h3 className="font-semibold text-xs text-foreground line-clamp-2">{product.name}</h3>
        ...
        <div className="mt-2 pt-2 border-t border-border">
          ...
          <code className="text-xs bg-muted px-1.5 py-0.5 rounded font-mono break-all block mb-2">{product.sku}</code>
